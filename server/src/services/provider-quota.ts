...
function isSharedPool(platform: Platform): boolean {
  return ['openrouter', 'google', 'groq', 'cerebras', 'sambanova', 'nvidia', 'mistral', 'github', 'cohere', 'cloudflare', 'zhipu', 'ollama', 'kilo', 'pollinations', 'llm7', 'huggingface', 'opencode', 'routeway', 'bazaarlink', 'ainative', 'aion', 'requesty', 'nara', 'aihorde', 'modelscope', 'glhf', 'aionlabs', 'chutes', 'grok', 'deepseek', 'xai', 'nscale', 'nebius', 'alibaba', 'ai21'].includes(platform);
}
